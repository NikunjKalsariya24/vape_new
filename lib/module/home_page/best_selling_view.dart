...
class BestSellingView extends StatefulWidget {
  ...
  String? token;
   ...
   BestSellingView({required this.bestSellingModel,required this.token,super.key});
...
@override
  ...
  getAllProduct() async {
    ...
    nonVariationCartProduct.forEach((element) {
      widget.bestSellingModel?.bestSellingProducts
  ...
  Widget build(BuildContext context) {
    ...
    return widget.bestSellingModel?.bestSellingProducts?.length==0?SizedBox(): Column(children: [
SizedBox(height: SizeUtils.verticalBlockSize*3,),
      ...
      SizedBox(
        ...
        child: ListView.builder(
          shrinkWrap: true,
          itemCount:
          widget.bestSellingModel?.bestSellingProducts?.length ??
              0,
                    ...
                    children: [
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              ...
                              Get.toNamed(Routes.productDetails, arguments: {
                                'productId': widget.bestSellingModel!.bestSellingProducts![index].id,
                                'productSlug': widget.bestSellingModel!.bestSellingProducts![index].slug,
                              })!.then((value) {
                            ...
                            child: ClipRRect(
                              ...
                              const BorderRadius.only(
                                  ...
                                  Radius.circular(15)),
                              child: Image.network(
                                  "${   widget.bestSellingModel!.bestSellingProducts![index].image!.original}",
                                  fit: BoxFit.fill,
                                  height: SizeUtils
                                      .verticalBlockSize *
                                      23,
                          ...
                          Padding(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                print(
                                    "popularProductModel!.popularProducts![index].inWishlist======${   widget.bestSellingModel!.bestSellingProducts![index].id}");
                                print("like");
                                ...
                                if (   widget.token != null) {
                                  ...
                                  toggleWishListModel = await graphQLService.wishListToggle(widget.bestSellingModel!.bestSellingProducts![index].id!, widget.token ?? "");
                                  print(
                                      "toggleWishListModelget========${toggleWishListModel!.toggleWishlist}");
                                  inWishListModel =
                                  await graphQLService
                                      .inWishList(
                                      widget.bestSellingModel!
                                          .bestSellingProducts![
                                      index]
                                          .id!,
                                      widget.token ?? "");
                                ...
                                print(
                                    "popularProductModel!.popularProducts![index].inWishlist======${   widget.bestSellingModel!.bestSellingProducts![index].id}");
                                print(
                                    "popularProductModel!.popularProducts![index].inWishlist======${   widget.bestSellingModel!.bestSellingProducts![index].inWishlist}");
                              },
                              child: Image.asset(
                                widget.bestSellingModel!
                                    .bestSellingProducts![
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: CustomText(
                                maxLines: 1,
                                name:
                                "${   widget.bestSellingModel!.bestSellingProducts![index].name}",
                      ...
                      Row(
                        children: [
                          ...
                          CustomText(
                            name:
                            "Rp${   widget.bestSellingModel!.bestSellingProducts![index].salePrice}",
                          ...
                          CustomText(
                            name:
                            "/ ${   widget.bestSellingModel!.bestSellingProducts![index].unit}",
                            color: AppColor.grayColor,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    CustomText(
                                      name:
                                      "Rp ${   widget.bestSellingModel!.bestSellingProducts![index].price}",
                                      color:
                                      AppColor.greenColor,
                                      fontSize:
                                      SizeUtils.fSize_12(),
                                    ...
                                    CustomText(
                                      name:
                                      "Rp ${   widget.bestSellingModel!.bestSellingProducts![index].maxPrice}",
                                      color: AppColor
                                          .grayTextColor,
                                      fontSize:
                                      SizeUtils.fSize_11(),
                            ...
                            widget.bestSellingModel!.bestSellingProducts![index].qtn == null ||   widget.bestSellingModel!.bestSellingProducts![index].qtn ==0
                              ...
                              if(token!="")
                                {
                                  ...
                                  await graphQLService
                                      .variationsProduct(
                                      widget.token ?? "",
                                      widget.bestSellingModel!.bestSellingProducts![index]
                                          .id!);

                                  if (variationsProductModel!
                                      .product!.variations!.isEmpty) {
                                    count = int.parse(
                                        "${widget.bestSellingModel!.bestSellingProducts![index].qtn == null ? 0 : widget.bestSellingModel!.bestSellingProducts![index].qtn}");

                                    setState(() {
                                      widget.bestSellingModel!.bestSellingProducts![index]
                                          .qtn = count + 1;
                                    });
                                    await bestSellingAddProduct(
                                      widget.bestSellingModel!.bestSellingProducts![index].id,
                                      widget.bestSellingModel!.bestSellingProducts![index]
                                          .image!
                                          .original,
                                      widget.bestSellingModel!.bestSellingProducts![index]
                                          .salePrice
                                          .toString(),
                                      widget.bestSellingModel!.bestSellingProducts![index].qtn,
                                      widget.bestSellingModel!.bestSellingProducts![index].name,
                                      widget.bestSellingModel!.bestSellingProducts![index].unit,
                                    );
                                  }
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(onTap: () async {
                                          ...
                                          print("tap");
                                          if (widget.bestSellingModel!.bestSellingProducts![
                                          index]
                                              .qtn !=
                                              null &&
                                              int.parse(widget.bestSellingModel!.bestSellingProducts![
                                              index]
                                                  .qtn
                                                  .toString()) !=
                                                  0) {
                                            count = int.parse(widget.bestSellingModel!.bestSellingProducts![
                                            index]
                                                .qtn
                                                .toString());
                                            print("count=====$count");
                                            ...
                                            index]
                                              ...
                                              index]
                                                  .qtn = null;
                                              print(
                                                  " popularProduct.qtn====${widget.bestSellingModel!.bestSellingProducts![index].qtn}");


                                              productRemoveModel =
                                                  await graphQLService
                                                  .cartProductRemove(widget.bestSellingModel!.bestSellingProducts![
                                              index]
                                                  .id!);

                                              print(
                                                  "addProductModel====${widget.bestSellingModel!.bestSellingProducts![index].id}");
                                              if (productRemoveModel!
                                                  .addtocartProductRemove ==
                                                  "Success") {
                                                await  bestSellingDecreaseProduct(
                                                    widget.bestSellingModel!.bestSellingProducts![
                                                    index]
                                                        .id,
                                                    widget.bestSellingModel!.bestSellingProducts![
                                            ...
                                            print(
                                                "qtn=====${widget.bestSellingModel!.bestSellingProducts![index].qtn}");
                                            saveListInSharedPreferences();
                                          }
                                          setState(() {});
                                        },
                                        ...
                                        GestureDetector(onTap: () async {
                                          ...
                                          count = int.parse( widget.bestSellingModel!.bestSellingProducts![index]
                                              .qtn
                                              .toString());
                                          ...
                                          widget.bestSellingModel!.bestSellingProducts![index]
                                              .qtn = count + 1;
                                          setState(() {});
                                          await bestSellingIncreaseProduct(
                                              widget.bestSellingModel!.bestSellingProducts![
                                          index]
                                              .id,
                                              widget.bestSellingModel!.bestSellingProducts![
  ...
  bestSellingAddProduct(  String? productId,
      String? productImage,
      String productPrice,
    ...
    await storeBestSellingProduct(productId, productImage, productPrice,
    productQuantity, productName, productUnit);

    await saveListInSharedPreferences();
  }

  Future<void> storeBestSellingProduct(
      String productId,
      String? productImage,
      String productPrice,
      dynamic productQuantity,
  ...
  bestSellingDecreaseProduct(String? productId,
  String? productImage,
  String productPrice,
  dynamic productQuantity,
  String? productName,
  ...
  bestSellingIncreaseProduct( String? productId,
      String? productImage,
      String productPrice,
      dynamic productQuantity,
      String? productName,
