...
class NewProductView extends StatefulWidget {
  ...
  String? token;
   NewProductView({required this.newProductModel,required this.token,super.key});
...
class _NewProductViewState extends State<NewProductView> {
  ...
  getAllProduct() async {
    ...
    nonVariationCartProduct.forEach((element) {
      widget.newProductModel?.products?.data
      ...
      Align(
        ...
        child: SizedBox(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount:
            widget.newProductModel?.products?.data?.length ?? 0,
                      ...
                      children: [
                              ...
                              onTap: () {
                                ...
                                Get.toNamed(Routes.productDetails,
                                    arguments: {
                                      ...
                                      'productId': widget.newProductModel!.products!.data![index].id,

                                      'productSlug':  widget.newProductModel!.products!.data![index].slug,
                              ...
                              child: ClipRRect(
                                ...
                                const BorderRadius.only(
                                    ...
                                    Radius.circular(
                                        15)),
                                child: Image.network(
                                    "${   widget.newProductModel!.products!.data![index].image!.original}",
                                    fit: BoxFit.fill,
                                    height: SizeUtils
                                        .verticalBlockSize *
                                        23,
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: CustomText(
                                  maxLines: 1,
                                  name:
                                  "${   widget.newProductModel!.products!.data![index].name}",
                                  fontSize:
                                  SizeUtils.fSize_14(),
                        ...
                        Row(
                          children: [
                            ...
                            CustomText(
                              name:
                              "Rp${   widget.newProductModel!.products!.data![index].salePrice}",
                            ...
                            CustomText(
                              name:
                              "/ ${   widget.newProductModel!.products!.data![index].unit}",
                              color: AppColor.grayColor,
                          ...
                          child: Row(
                            children: [
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      CustomText(
                                        name:
                                        "Rp ${   widget.newProductModel!.products!.data![index].price}",
                                        color:
                                        AppColor.greenColor,
                                        fontSize: SizeUtils
                                            .fSize_12(),
                                      ...
                                      CustomText(
                                        name:
                                        "Rp ${   widget.newProductModel!.products!.data![index].maxPrice}",
                                        color: AppColor
                                            .grayTextColor,
                                        fontSize: SizeUtils
                                            .fSize_11(),
                              ...
                              const SizedBox(
                               ...
                               widget.newProductModel!.products!.data![index].qtn == null ||  widget.newProductModel!.products!.data![index].qtn == 0 ? Padding(
                                 ...
                                 child: GestureDetector(onTap:() async {
                                              ...
                                              if(token!=""){
                                                ...
                                                await graphQLService
                                                    .variationsProduct(
                                                    widget.token ?? "",
                                                    widget.newProductModel!.products!.data![index]
                                                        .id!);

                                                if (variationsProductModel!
                                                    .product!.variations!.isEmpty) {
                                                  count = int.parse(
                                                      "${ widget.newProductModel!.products!.data![index].qtn == null ? 0 :  widget.newProductModel!.products!.data![index].qtn}");

                                                  setState(() {
                                                    widget.newProductModel!.products!.data![index]
                                                        .qtn = count + 1;
                                                  });
                                                  await newProductAddProduct(
                                                    widget.newProductModel!.products!.data![index].id,
                                                    widget.newProductModel!.products!.data![index]
                                                        .image!
                                                        .original,
                                                    widget.newProductModel!.products!.data![index]
                                                        .salePrice
                                                        .toString(),
                                                    widget.newProductModel!.products!.data![index].qtn,
                                                    widget.newProductModel!.products!.data![index].name,
                                                    widget.newProductModel!.products!.data![index].unit,
                                                  );
                                                }
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(onTap: () async {
                                            ...
                                            if (widget.newProductModel!.products!.data![
                                            index]
                                                .qtn !=
                                                null &&
                                                int.parse(widget.newProductModel!.products!.data![
                                                index]
                                                    .qtn
                                                    .toString()) !=
                                                    0) {
                                              count = int.parse(widget.newProductModel!.products!.data![
                                              index]
                                                  .qtn
                                                  .toString());
                                              print("count=====$count");
                                              ...
                                              index]
                                                ...
                                                index]
                                                    .qtn = null;
                                                print(
                                                    " popularProduct.qtn====${widget.newProductModel!.products!.data![index].qtn}");


                                                productRemoveModel =
                                                    await graphQLService
                                                    .cartProductRemove(widget.newProductModel!.products!.data![
                                                index]
                                                    .id!);

                                                print(
                                                    "addProductModel====${widget.newProductModel!.products!.data![index].id}");
                                                if (productRemoveModel!
                                                    .addtocartProductRemove ==
                                                    "Success") {
                                                  await newProductDecrease(
                                                      widget.newProductModel!.products!.data![
                                                      index]
                                                          .id,
                                                      widget.newProductModel!.products!.data![
                                              ...
                                              print(
                                                  "qtn=====${ widget.newProductModel!.products!.data![index].qtn}");
                                              saveListInSharedPreferences();
                                            }
                                            setState(() {});
                                          },
                                          ...
                                          GestureDetector(onTap: () async {
                                            ...
                                            count = int.parse( widget.newProductModel!.products!.data![index]
                                                .qtn
                                                .toString());
  ...
  newProductAddProduct( String? productId,
      String? productImage,
      String productPrice,
    ...
    await storeNewProduct(productId, productImage, productPrice,
    productQuantity, productName, productUnit);

    await saveListInSharedPreferences();
  }

  storeNewProduct(String productId, String? productImage, String productPrice, productQuantity, String? productName, String? productUnit) async {
  ...
  newProductDecrease( String? productId,
      String? productImage,
      String productPrice,
      dynamic productQuantity,
      String? productName,
  ...
  newProductIncrease(String? productId,
      String? productImage,
      String productPrice,
      dynamic productQuantity,
      String? productName,
